...
Установщик сам использует pinned release tag, создаёт временный checkout,
проверяет его, выполняет установку и удаляет временные файлы. Параметр `--ref`
остаётся только для администратора, которому нужно явно выбрать другой
проверенный release tag или commit.
...
1. проверяет Ubuntu, существующие пути, владельцев, типы файлов и pinned-версию
   Hermes Agent;
...
проверку владельцев, режимов или pinned-версии, дальнейшее обслуживание и
